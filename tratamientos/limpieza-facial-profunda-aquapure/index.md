      ...
      <main class="mt-10 mx-auto max-w-2xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="text-center xl:text-left">
          <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-5xl">
            <span class="block text-rose xl:inline">Limpieza facial
              profunda</span>
...
<div class="pt-12 pb-8 bg-coal">
  <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-24">
      <div>
        <div class="flex justify-center mb-8">
          <img src="peeling.png" class="h-48
            ...
            <div class="bg-white rounded-t-lg px-6 pt-12 pb-10">
              <div>
                ...
                <div class="text-sm mt-2 mx-8 md:mx-12">
                  * por sesión en pack de 3 sesiones (total 420€). Sesión
                  única sin pack por 170€.
                </div>
              </div>
            </div>
